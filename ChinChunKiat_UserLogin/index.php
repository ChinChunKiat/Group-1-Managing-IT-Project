...
<body>
    ...
    <div class="bg-image d-flex" style="background-image: url('./image/background.png'); height: 100vh;">
        <div class="container" style="border-radius: 1rem;">
            <div class="row">
                <div class="col-md-5" style="background: #434343; border-radius: 1rem; margin-top: 10%;">
                    <div class="col">
                        <h1 class="intro-text">PastiNyala</h1>
                    </div>
                    <div class="button_choosen">
                        <h4 class="Login-As">Login As?</h4>
                ...
                <!-- <div class="right_side">If want to add something at the right side</div> -->
            </div>
        </div>
    </div>
</body>
